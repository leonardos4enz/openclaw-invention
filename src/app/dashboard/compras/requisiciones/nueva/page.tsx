...
export default function NuevaRequisicionPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(data.error || 'Error al crear requisición')
      }
  ...
  return (
    <div>
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Nueva Requisición</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                className="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500"
                rows={3}
                placeholder="Describe brevemente la necesidad de compra..."
                required
              />
            </div>
